...
export async function generateEmbedding(text) {
  ...
  if (EMBEDDING_DIMENSIONS) params.dimensions = parseInt(EMBEDDING_DIMENSIONS, 10);
...
export async function generateBatchEmbeddings(texts, batchSize = 100) {
  ...
  for (let i = 0; i < texts.length; i += batchSize) {
    ...
    if (EMBEDDING_DIMENSIONS) batchParams.dimensions = parseInt(EMBEDDING_DIMENSIONS, 10);
...
export { OPENAI_API_KEY, EMBEDDING_API_KEY, EMBEDDING_ENABLED, EMBEDDING_MODEL, EMBEDDING_DIMENSIONS };
