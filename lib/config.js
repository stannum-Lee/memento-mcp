 ...
 *   voyage   — Voyage AI. VOYAGE_API_KEY 필요. input_type / output_dimension 전용 REST 경로 사용.
...
const _PROVIDER_DEFAULTS = {
  ...
  voyage:       { model: "voyage-4-large",          dims: 1024,  baseUrl: "https://api.voyageai.com/v1/embeddings",                  supportsDimensionsParam: false, inProcess: false },
...
export const EMBEDDING_API_KEY           = (() => {
  if (EMBEDDING_PROVIDER === "voyage") {
    return VOYAGE_API_KEY || process.env.EMBEDDING_API_KEY || "";
  }
